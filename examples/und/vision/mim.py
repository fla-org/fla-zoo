...
from fla.models.retnet import RetNetForMaskedImageModeling, RetNetVisionConfig
import transformers
...
def main():
    ...
    config = RetNetVisionConfig(num_hidden_layers=6, hidden_size=256)
    ...
    model = RetNetForMaskedImageModeling(config=config)

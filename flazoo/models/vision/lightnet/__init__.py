...
from .modeling_lightnet import(LightNetVisionModel,
...
AutoModelForImageClassification.register(LightNetVisionConfig, LightNetForImageClassification)
AutoModelForMaskedImageModeling.register(LightNetVisionConfig, LightNetForMaskedImageModeling)

__all__ = ['LightNetVisionModel', 'LightNetForImageClassification', 'LightNetForMaskedImageModeling', 'LightNetVisionConfig']

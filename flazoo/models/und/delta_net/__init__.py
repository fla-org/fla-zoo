...
AutoModelForMaskedImageModeling.register(
    DeltaNetVisionConfig, DeltaNetForMaskedImageModeling
)
...
from .modeling_delta_net import (
    DeltaNetVideoModel,
    DeltaNetForVideoClassification,
    DeltaNetForVideoPreTraining,
)
...
AutoModelForVideoClassification.register(
    DeltaNetVideoConfig, DeltaNetForVideoClassification
)

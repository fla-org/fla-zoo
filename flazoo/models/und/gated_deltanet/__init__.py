...
AutoModelForMaskedImageModeling.register(
    GatedDeltaNetVisionConfig, GatedDeltaNetForMaskedImageModeling
)
...
from .modeling_gated_deltanet import (
    GatedDeltaNetVideoModel,
    GatedDeltaNetForVideoClassification,
    GatedDeltaNetForVideoPreTraining,
)
...
AutoModelForVideoClassification.register(
    GatedDeltaNetVideoConfig, GatedDeltaNetForVideoClassification
)
AutoModelForPreTraining.register(
    GatedDeltaNetVideoConfig, GatedDeltaNetForVideoPreTraining
)

...
class GatedDeltaNetForImageClassification(GatedDeltaNetVisionPreTrainedModel):
    def __init__(self, config):
        ...
        self.backbone = GatedDeltaNetVisionModel(
...
class GatedDeltaNetVideoEncoder(nn.Module):
    def __init__(self, config) -> None:
        ...
        self.blocks = nn.ModuleList(
            [
                GatedDeltaNetVideoBlock(config, layer_idx)
                for layer_idx in range(config.num_hidden_layers)
            ]
        )
        self.gradient_checkpointing = False
...
class GatedDeltaNetVideoDecoder(nn.Module):
    def __init__(self, config, num_patches):
        ...
        self.decoder_blocks = nn.ModuleList(
            [
                GatedDeltaNetVideoBlock(decoder_config, layer_idx)
...
class GatedDeltaNetForVideoPreTraining(GatedDeltaNetVideoPreTrainedModel):
    def __init__(self, config):
        ...
        self.decoder = GatedDeltaNetVideoDecoder(

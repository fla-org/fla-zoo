...
# Huge thanks to developers at Hugging Face for their work on the Diffusers library!
...
class DiTFLA2DModel(ModelMixin, ConfigMixin):
    r"""
    A 2D FLA model adapted from DiT (https://arxiv.org/abs/2212.09748).
